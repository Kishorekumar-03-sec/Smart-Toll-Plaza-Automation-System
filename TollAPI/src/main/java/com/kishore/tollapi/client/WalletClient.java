...
public class WalletClient {
    ...
    public WalletResponse deductBalance(DeductRequest deductRequest) {
        ...
        String url = "http://localhost:8080/api/v1/wallets/deduct";
        ...
        try {
            ...
            throw new InsufficientBalanceException(
                    "Insufficient balance for deduction of toll pay");
        }
    }

    public WalletResponse getWalletByFastagId(String fastagId) {

        String url = "http://localhost:8080/api/v1/wallets/" + fastagId;

        ResponseEntity<WalletResponse> response =
                restTemplate.getForEntity(url, WalletResponse.class);
